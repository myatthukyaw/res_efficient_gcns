...
def pkummd():
    ...
    with open('/media/mtk/559be1a1-ed84-4771-ac8e-97e50374afcd/Workspace/pkummd/labels/0298-R.txt', 'r') as f:
    ...
    with open('/media/mtk/559be1a1-ed84-4771-ac8e-97e50374afcd/Workspace/pkummd/skeletons/0298-R.txt', 'r') as f:
