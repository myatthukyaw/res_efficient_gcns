...
class ResGCN_Module(nn.Module):
    def __init__(self, in_channels, out_channels, block, A, initial=False, stride=1, kernel_size=[9,2], **kwargs):
        ...
        #spatial_block = U.import_class('ResGCNv1.src.model.blocks.Spatial_{}_Block'.format(block))
        #temporal_block = U.import_class('ResGCNv1.src.model.blocks.Temporal_{}_Block'.format(block))
