...
class Visualizer():
    def __init__(self, args):
        ...
        self.action_names['gw'] = [ 'fighting', 'smoke', 'stand', 'walk']

        self.action_names['rtar'] = [ 'jump','kick', 'punch', 'sit','squat', 'stand', 'walk','wave']
        self.action_names['zensho'] = [ 'Input meat', 'Input onion', 'Remove oil','Submerge meat' , 'Submerge onion' ]
